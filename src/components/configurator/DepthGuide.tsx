    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <div className="text-center">
          <div className="relative mx-auto mb-2 w-full max-w-[60px]">
          ...
          <span className="text-sm font-mono font-semibold text-foreground">15mm</span>
        ...
        <div className="text-center relative">
          ...
          <div className="relative mx-auto mb-2 w-full max-w-[60px] mt-4">
            <div className="h-10 bg-gradient-to-b from-valid/60 to-valid/80 rounded-t-sm" />
            <div className="h-1 bg-foreground/20 rounded-b-sm" />
          </div>
          <span className="text-sm font-mono font-semibold text-foreground">20mm</span>
        ...
        <div className="text-center">
          ...
          <span className="text-sm font-mono font-semibold text-foreground">25mm</span>
