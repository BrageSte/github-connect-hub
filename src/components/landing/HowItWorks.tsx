              ...
              >
                ...
                <div className="text-center">
                  ...
                  <div className="relative inline-block mb-6">
                    ...
                    {/* Step number */}
                    <span className="absolute -top-3 -right-3 w-8 h-8 bg-primary text-primary-foreground text-sm font-bold rounded-full flex items-center justify-center z-20">
                      {step.number}
                    </span>
                  </div>
          ...
          <div className="card max-w-4xl mx-auto">
            <div className="aspect-video bg-background rounded-xl flex items-center justify-center border border-border">
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground text-sm">Se konfiguratoren i aksjon</p>
              </div>
            </div>
          </div>
        </motion.div>
