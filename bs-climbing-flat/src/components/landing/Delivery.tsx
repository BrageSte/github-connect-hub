            ...
            <div className="space-y-4">
              {Object.entries(PICKUP_LOCATIONS).map(([key, location]) => (
                ...
                >
                  ...
                  <div className="text-sm text-text-muted mb-2">{location.address}</div>
          ...
          >
            ...
            <div className="p-4 bg-background rounded-xl border border-border">
              <div className="flex items-center justify-between mb-2">
                <span className="text-text-muted">Fraktpris</span>
                <span className="font-medium">Beregnes ved checkout</span>
              </div>
              <div className="flex items-center justify-between text-sm">
                <span className="text-text-muted">Leveringstid</span>
                <span className="text-text-muted">2-5 virkedager</span>
              </div>
            </div>
