        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-sm text-text-muted">Nå tilgjengelig</span>
            </motion.div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Link href="/configure" className="btn-primary text-base px-8 py-4">
                Konfigurer Stepper
                <ArrowRight size={18} />
              </Link>
              <Link href="#hvordan" className="btn-secondary text-base px-8 py-4">
                Hvordan funker det?
              </Link>
            </div>
            ...
            <div className="flex flex-wrap gap-6 justify-center lg:justify-start mt-10 pt-10 border-t border-border">
              <div className="text-center">
                ...
                <div className="text-sm text-text-muted">Toleranse</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold">4</div>
                <div className="text-sm text-text-muted">Grep per blokk</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold">STL</div>
                <div className="text-sm text-text-muted">Ferdig fil</div>
              </div>
            </div>
          </motion.div>
            ...
            <div className="relative aspect-square max-w-lg mx-auto">
              ...
              <div className="relative bg-surface border border-border rounded-3xl p-8 h-full flex items-center justify-center">
                ...
                <div className="relative w-full aspect-[4/3]">
                  ...
                  {/* Labels */}
                  <div className="absolute top-4 left-4 text-xs text-text-muted font-mono">
                    PREVIEW
                  </div>
                  ...
                  <div className="absolute right-4 bottom-12 top-8 flex flex-col justify-between items-center">
                    ...
                    <span className="text-[10px] text-text-muted mt-2 font-mono">6-35mm</span>
                  </div>
                </div>
